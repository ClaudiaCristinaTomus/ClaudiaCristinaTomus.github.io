...
sr.reveal('.home__data, .about__img, .skills__subtitle, .skills__text, .work section', {});
sr.reveal('.home__img, .about__subtitle, .about__text,.button_about,.skills__img, .slide-container', { delay: 400 });
